import { type BotCommand, type ChatPermissions, type InlineQueryResult, type InputFile, type InputMedia, type InputMediaAudio, type InputMediaDocument, type InputMediaPhoto, type InputMediaVideo, type LabeledPrice, type PassportElementError } from "../types.js";
...
export declare class Api<R extends RawApi = RawApi> {
     ...
     */
    addStickerToSet(user_id: number, name: string, emojis: string, other?: Other<R, "addStickerToSet", "user_id" | "name" | "emojis">, signal?: AbortSignal): Promise<true>;
    /**
